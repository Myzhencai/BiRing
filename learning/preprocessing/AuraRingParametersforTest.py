...
def main():
    ...
    sensor_rot_offset =[120,60,20]  # x, y, z, w
    ring_offset = [8,9,9]
    # ring_rot_offset =[1,0.3,0.7,0.2]  # x, y, z, w
    ring_rot_offset =[42,45,90]  # x, y, z, w
    crosstalk = [3,2,4]
...
if __name__ == "__main__":
    ...
    # #
    # # print(base)
    # a2M = R.from_euler('xyz', [90, 90, 90], degrees=True).as_matrix()
    # a2 = R.from_euler('xyz', [90, 90, 90], degrees=True)
    # a3 = R.from_euler('xyz', [90, 90, 90], degrees=True).as_quat()
    # a3_q = R.from_quat(a3)
    # base_a2M = a2M @ base
    # base_a2_2 = a2.apply(base)
    # base_a2_3 = a3_q.apply(base)
    # print("end")
    #
    ...
    # print(newresult)
    #
    # startbase = np.c_[np.zeros((3,3)),np.array([1,1,1]).T]
    # newstart = x.dot(startbase.T)
    ...
    #
    # creat3d_vec_xyzold(basenew,test)
